...
export default function ReviewContainer({ productDetail }) {
  ...
  }, [dispatch, isAuthenticated, user, productDetail]);
    ...
    <div className={style.review_container}>
      ...
      <form onSubmit={(e) => handleSubmit(e)} className={style.review_form}>
        ...
        <button className={style.review_submit_button} type="submit">
          <FaPaperPlane
            className={style.plane_icon}
            style={boughts.length ? { pointerEvents: "none" } : {}}
          />
        </button>
      </form>
    </div>
